...
export function FAQSection() {
  const faqs = [
    {
      question: "Насколько безопасна процедура Данек Лох?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Да, Данек Лох разработан полностью обратимым. Устройство можно безопасно удалить при необходимости, хотя это требуется редко.",
    },
    {
      question: "Какие ощущения при использовании Данек Лох?",
      answer:
    ...
    {
      question: "Кто может получить Данек Лох?",
      answer:
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto font-space-mono">
            Ответы на популярные вопросы о технологии Данек Лох, безопасности и опыте пациентов.
          </p>
        </div>
